    ...
    return (
        ...
        >
                ...
                <div className="space-y-2 bg-green-50 p-3 rounded-lg">
                    {backgroundOptions.map((bgClass) => {
                        ...
                        const ringColor = {
                            ...
                            "bg-gradient-to-b from-blue-100 to-blue-200": "ring-blue-300",
                        }[bgClass] || "ring-gray-200";
                        ...
                        return (
                            <button
                                ...
                                className={`block w-full py-2 rounded-md text-sm border transition text-black ${isSelected
                                    ? `ring-2 ring-offset-2 ${ringColor} bg-white font-semibold`
            ...
            <div className="p-4 mt-6">
                <p className="text-sm font-medium text-gray-700 mb-2">텍스트 색상 선택</p>
                <input
                    type="color"
                    value={textColor}
            ...
            <div className="p-4 mt-6">
                <p className="text-sm font-medium text-gray-700 mb-2">사용자 배경 이미지</p>
                <label
                    htmlFor="bg-upload"
